...
export default function Vehicleopen() {
  ...
  return (
    <div className="bg-white h-[30rem] w-screen z-20 flex transition-all ease-in duration-300 ">
      <div className="grid grid-cols-4 w-[70%] pt-[4%] h-[60%] pl-[10%]">
        {vehicle_items.map((props, index) => (
          <div key={index} className="flex flex-col items-center pt-[8%]">
            <a href="">
              <img className="h-28 w-48" src={props.img} alt={props.name} />
            </a>
            <div>
